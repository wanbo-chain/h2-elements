...
export class CacheSearchUtil {
  ...
  /**
   * 新增缓存项
   * @param item 缓存对象POJO 如:{label:"天猫",business:"塑料"}
   * @param searches 缓存对象搜索关键字符串数组，包含了item的特定字段值，特定字段的全拼、简拼字符串,如：["天猫","KUAISUWANG","KSW","塑料","SULIAO","SL"]
   */
